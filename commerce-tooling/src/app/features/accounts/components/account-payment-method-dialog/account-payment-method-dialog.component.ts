...
@Component({
	templateUrl: "./account-payment-method-dialog.component.html",
	styleUrls: ["./account-payment-method-dialog.component.scss"]
})
export class AccountPaymentMethodDialogComponent implements OnInit, AfterViewInit {
	...
	constructor(
		...
		private dialogRef: MatDialogRef<AccountPaymentMethodDialogComponent>,
	...
	save() {
		...
		if (this.paymentMethodForm.valid) {
			...
			if (this.showCheckFields) {
				...
				if (!this.showCreditCardFields) {
					paymentMethod.checkingAccountNumber = null;
				}
