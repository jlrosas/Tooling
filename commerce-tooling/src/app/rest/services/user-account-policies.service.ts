...
class UserAccountPoliciesService extends __BaseService {
   ...
   */
  getUserAccountPoliciesResponse(params: UserAccountPoliciesService.GetUserAccountPoliciesParams): __Observable<__StrictHttpResponse<{count?: number, items?: Array<{id?: number, userAccountLockoutPolicyId?: string, passwordPolicyId?: string}>}>> {
   ...
   * @return A collection of user account policies records.
   */
  getUserAccountPolicies(params: UserAccountPoliciesService.GetUserAccountPoliciesParams): __Observable<{count?: number, items?: Array<{id?: number, userAccountLockoutPolicyId?: string, passwordPolicyId?: string}>}> {
   ...
   */
  createUserAccountPolicyResponse(UserAccountPolicy: {id?: number, userAccountLockoutPolicyId?: string, passwordPolicyId?: string}): __Observable<__StrictHttpResponse<null>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @param UserAccountPolicy The user account policy.
   */
  createUserAccountPolicy(UserAccountPolicy: {id?: number, userAccountLockoutPolicyId?: string, passwordPolicyId?: string}): __Observable<null> {
   ...
   */
  getUserAccountPolicyByIdResponse(params: UserAccountPoliciesService.GetUserAccountPolicyByIdParams): __Observable<__StrictHttpResponse<{id?: number, userAccountLockoutPolicyId?: string, passwordPolicyId?: string}>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    return this.http.request<any>(req).pipe(
      __filter(_r => _r instanceof HttpResponse),
      __map((_r) => {
        return _r as __StrictHttpResponse<{id?: number, userAccountLockoutPolicyId?: string, passwordPolicyId?: string}>;
      })
    );
  }
   ...
   * @return The user account policy.
   */
  getUserAccountPolicyById(params: UserAccountPoliciesService.GetUserAccountPolicyByIdParams): __Observable<{id?: number, userAccountLockoutPolicyId?: string, passwordPolicyId?: string}> {
    return this.getUserAccountPolicyByIdResponse(params).pipe(
      __map(_r => _r.body as {id?: number, userAccountLockoutPolicyId?: string, passwordPolicyId?: string})
    );
  }
...
module UserAccountPoliciesService {
  ...
  export interface UpdateUserAccountPolicyByIdParams {
     ...
     */
    UserAccountPolicy: {id?: number, userAccountLockoutPolicyId?: string, passwordPolicyId?: string};
