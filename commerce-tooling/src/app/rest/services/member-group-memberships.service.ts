...
class MemberGroupMembershipsService extends __BaseService {
   ...
   */
  getMemberGroupMembershipsResponse(params: MemberGroupMembershipsService.GetMemberGroupMembershipsParams): __Observable<__StrictHttpResponse<{count?: number, items?: Array<{memberId?: string, memberGroupId?: string, field1?: string, exclude?: string}>}>> {
    ...
    return this.http.request<any>(req).pipe(
      ...
      __map((_r) => {
        return _r as __StrictHttpResponse<{count?: number, items?: Array<{memberId?: string, memberGroupId?: string, field1?: string, exclude?: string}>}>;
      })
    );
  }
   ...
   * @return A collection of member group memberships.
   */
  getMemberGroupMemberships(params: MemberGroupMembershipsService.GetMemberGroupMembershipsParams): __Observable<{count?: number, items?: Array<{memberId?: string, memberGroupId?: string, field1?: string, exclude?: string}>}> {
    return this.getMemberGroupMembershipsResponse(params).pipe(
      __map(_r => _r.body as {count?: number, items?: Array<{memberId?: string, memberGroupId?: string, field1?: string, exclude?: string}>})
    );
  }
   ...
   */
  createMemberGroupMembershipResponse(MemberGroupMembership: {memberId?: string, memberGroupId?: string, field1?: string, exclude?: string}): __Observable<__StrictHttpResponse<null>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @param MemberGroupMembership A member group membership, which is an association of a member (user or organization) to a member group.
   */
  createMemberGroupMembership(MemberGroupMembership: {memberId?: string, memberGroupId?: string, field1?: string, exclude?: string}): __Observable<null> {
   ...
   */
  getMemberGroupMembershipByIdResponse(params: MemberGroupMembershipsService.GetMemberGroupMembershipByIdParams): __Observable<__StrictHttpResponse<{memberId?: string, memberGroupId?: string, field1?: string, exclude?: string}>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    return this.http.request<any>(req).pipe(
      __filter(_r => _r instanceof HttpResponse),
      __map((_r) => {
        return _r as __StrictHttpResponse<{memberId?: string, memberGroupId?: string, field1?: string, exclude?: string}>;
      })
    );
  }
   ...
   * @return A member group membership, which is an association of a member (user or organization) to a member group.
   */
  getMemberGroupMembershipById(params: MemberGroupMembershipsService.GetMemberGroupMembershipByIdParams): __Observable<{memberId?: string, memberGroupId?: string, field1?: string, exclude?: string}> {
    return this.getMemberGroupMembershipByIdResponse(params).pipe(
      __map(_r => _r.body as {memberId?: string, memberGroupId?: string, field1?: string, exclude?: string})
    );
  }
