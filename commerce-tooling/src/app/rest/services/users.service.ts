...
class UsersService extends __BaseService {
   ...
   */
  UsersFindByUserIdResponse(id: string): __Observable<__StrictHttpResponse<any>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
   ...
   * @return The requested completed successfully.
   */
  UsersFindByUserId(id: string): __Observable<any> {
   ...
   * @return The requested completed successfully.
   */
  UsersGetUserRolesResponse(id: string): __Observable<__StrictHttpResponse<any>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/rest/admin/v2/users/${id}/roles`,
      __body,
      {
        headers: __headers,
        params: __params,
   ...
   * @return The requested completed successfully.
   */
  UsersGetUserRoles(id: string): __Observable<any> {
    return this.UsersGetUserRolesResponse(id).pipe(
      __map(_r => _r.body as any)
    );
  }
